      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {userRole === "authority" ? (
              <Link to="/authoritydashboard" className="bg-[#023E8A] text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">
                Authority Dashboard
              </Link>
            ) : userRole === "user" ? (
              <Link to="/userdashboard" className="bg-[#023E8A] text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">
                User Dashboard
              </Link>
            ) : (
              <Link to="/login" className="bg-[#023E8A] text-white hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium">
                Login
              </Link>
            )}
          </nav>
