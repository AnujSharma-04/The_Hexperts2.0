...
const AboutUs = () => {
  return (
    <div>
      ...
      <div className="bg-[#FBFCFF] text-[#051650] py-16 px-6 sm:px-12 rounded-b-lg shadow-lg">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold leading-tight mb-4">
            Empowering Communities, One Report at a Time
          </h1>
          <p className="mt-4 text-xl text-[#051650]">
      ...
      <div className="max-w-4xl mx-auto py-12 px-6 sm:px-12">
        ...
        <div className="mt-8">
          <h2 className="text-3xl font-semibold text-[#FCFBFF]">Why Choose Us?</h2>
          <ul className="mt-4 space-y-6">
            <li className="flex items-center text-lg text-[#FCFBFF] hover:text-indigo-600 transition duration-300">
